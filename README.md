...
拡張機能がONの状態でWebブラウザを開くと、自由に移動できる操作ボタンが右下に出現します。
...
-  問題文しかなくても**Ai解説機能**で解説文を生成　--> そのままカードとして作成
...
4. このプロジェクトのフォルダ (`AnkiProject`) を選択(先にローカルディレクトリにこのプロジェクトを`Clone`してください)
5. ツールバーから拡張機能が有効化されたかを確認してください 
